# -*- encoding: utf-8 -*-
# stub: devise-two-factor 3.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2017-11-21"
  s.description = "Barebones two-factor authentication with Devise".freeze
  s.email = "engineers@tinfoilsecurity.com".freeze
  s.homepage = "https://github.com/tinfoil/devise-two-factor".freeze
  s.licenses = ["MIT".freeze]
  s.rubyforge_project = "devise-two-factor".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_dependency(%q<attr_encrypted>.freeze, ["!= 2", "< 4", ">= 1.3"])
      s.add_dependency(%q<devise>.freeze, ["~> 4.0"])
      s.add_dependency(%q<rotp>.freeze, ["~> 2.0"])
